...
class Toggle extends React.Component {
    ...
    render() {
        return (
            <div style={{ display: "flex", justifyContent: "center", flexDirection: "column", backgroundColor: "blue", width: "100%" }}>
                <CardSpecial chart style={{ display: "flex", justifyContent: "center", flexDirection: "column", backgroundColor: "red" }}>
                    <View style={{ display: "flex", justifyContent: "center", flexDirection: "column", backgroundColor: "red" }} onClick={this.handleClick}>
